...
index = load_index_from_storage(storage_context,service_context = ServiceContext.from_defaults(llm=openai.OpenAI("gpt-4o", temperature=0),embed_model=embed_model))
...
service_context = ServiceContext.from_defaults(llm=openai.OpenAI(model="gpt-4o", temperature=0),embed_model=embed_model)
